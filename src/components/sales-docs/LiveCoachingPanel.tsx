...
export default function LiveCoachingPanel({
  ...
  return (
    <aside className="flex h-full w-[240px] shrink-0 flex-col overflow-y-auto border-l border-[var(--sd-border)] bg-[var(--sd-bg)]">
      ...
      {pending ? (
        <div className="mx-4 rounded-xl border border-[var(--sd-border)] bg-[var(--sd-panel)] px-3.5 py-3">
          <div className="text-[12px] text-[var(--sd-text-secondary)]">Standing by</div>
          <div className="mt-1 text-[11.5px] leading-snug text-[var(--sd-text-muted)]">
