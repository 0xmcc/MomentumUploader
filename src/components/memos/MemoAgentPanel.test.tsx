...
describe("MemoAgentPanel", () => {
  ...
  it("rounds displayed credits down to a whole number", async () => {
    ...
    expect(await screen.findByText("96 credits")).toBeInTheDocument();
    expect(screen.queryByText("96.205 credits")).toBeNull();
  });
