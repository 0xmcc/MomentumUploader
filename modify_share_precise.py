...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .disc-avatar-fallback { display: inline-flex; align-items: center; justify-content: center; background: rgba(255,255,255,0.1); font-weight: 700; }
    .disc-author { font-weight: 600; }
    .disc-time { color: #f97316; }
    .disc-content { margin: 0; white-space: pre-wrap; }
    ...
    /* other legacy styles simplified to avoid breaking layout */
  </style>
</head>
<body>
...
new_content = content[:start_html_idx] + new_html
